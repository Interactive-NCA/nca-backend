...
#                                               "exp_name": exp_name,
                    ...
                    "fixed_tiles": batch_config.fixed_tiles,
                    "random_fixed_tiles": args.random_fixed_tiles,
...
if __name__ == "__main__":
    ...
    opts.add_argument(
        ...
        type=int,
        default=None,
        help="Number of randomly generated fixed tiles to be passed in each forward pass."
    )

    opts.add_argument(
        "--binary_channel",
        help="Add a binary map to the input based on the fixed tiles",
        action="store_true",
    )
